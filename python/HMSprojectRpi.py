...
emergency_Dial = {'doctor1': '8686618977', 'doctor2': '7036431896', 'hospital': '12345678', 'Ambulence': '108', 'Relatives': '8686608733'}
...
def SensorDataRequest():
    ...
    GPIO.output(ARDUNO_SERIAL, GPIO.HIGH)
    GPIO.output(GSM_SERIAL, GPIO.LOW)    
    serial.write("DATARQST")
    adrino = serial.Serial()
    
    for i in range(1,3):
        sensor_Data[i] = adrino.read()
        ''' Check for any alert '''
        if i == 1 and sensor_Data[i] > 95:
